...
const LFM_COLORS = {
    ...
    ELIGIBLE_RAID_GRADIENT_CENTER: "#5f3b25ff",
    ELIGIBLE_RAID_GRADIENT_EDGE: "#3b291dff",
    INELIGIBLE_RAID_GRADIENT_CENTER: "#331e11ff",
    INELIGIBLE_RAID_GRADIENT_EDGE: "#1f140dff",
    LFM_BORDER: "#898E6F",
